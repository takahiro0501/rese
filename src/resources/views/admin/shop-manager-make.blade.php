...
<div class="manager">
    ...
    <div class="manager__shop">
        <form action="{{ route('manager.shop.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="admin__form-parts">
                ...
                <textarea name="overview" class="shop-overview" >{{ old('overview') }}</textarea>
                @error('overview') 
            ...
            <div class="admin__form-parts">
                <x-select-time msg="start" />
            </div>
            <div class="admin__form-parts">
                <x-select-time msg="end" />
            </div>
            ...
            <div class="admin__form-submit" >
                <input type="submit" name="submit"  class="shop-btn" value="店舗作成" />
            </div>
        </form>
    </div>
